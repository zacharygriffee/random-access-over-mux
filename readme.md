...
Loading a file already loaded will return the already loaded file.
...
If unloading from the server, you can omit the filename and it will unload all files.
Working on the 'unload all' for client later.
